...
class _ClientSignIn extends State<ClientSignInPage> {
  ...
  void checkdata() async {
    ...
    if (email == null) {
      ...
      utils().toastMessage("User email is null");
      return;
    }
    ...
    try {
      try {
        ...
        print("Error fetching client role: $e");
      }
      ...
      try {
        ...
        print("Error fetching lawyer role: $e");
      }
      ...
      try {
        ...
        print("Error fetching authority role: $e");
      }
      ...
      if (name.toString() == "client") {
        ...
        utils().toastMessage("User Data not Found or Permission Denied.");
      }
    } catch (e) {
      setState(() {
        loading = false;
