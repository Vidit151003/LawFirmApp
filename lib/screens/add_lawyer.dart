...
class _AddLawyerState extends State<AddLawyer> {
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: "Lawyer's Full Name",
                              border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(15)),
                            ),
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                return 'Please enter the lawyer\'s name';
                              }
                              return null;
                            },
                          ),
                          ...
                          child: OvalButtonColor(
                              ...
                              onPressed: () async {
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  try {
                                    await signUp(emailController.text, passwordController.text, "lawyer");
                                    setState(() {
                                      loading=false;
                                    });
  ...
  Future<void> postDetailsToFirestore(String email, String role) async {
    ...
    await ref.doc(user!.email).set({
      ...
      'name': nameController.text.trim(),   // Name is now stored
      'email': email,
      'role': role,
    ...
    if (mounted) {
      ...
      utils().toastMessage("Lawyer Added Successfully");
    }
  }
}
