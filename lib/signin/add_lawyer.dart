...
//       context,
//       MaterialPageRoute(
//         builder: (context) => LawyerDashboard(),
//       ),
//     );
...
class _addlawyerState extends State<addlawyer> {
  ...
  postDetailsToFirestore(String email, String role) async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => lawyeradditionalinfo(userEmail: email),
      ),
    );
  }
}

class lawyeradditionalinfo extends StatefulWidget {
  final String userEmail;

  const lawyeradditionalinfo({super.key, required this.userEmail});

  @override
  _lawyeradditionalinfoState createState() => _lawyeradditionalinfoState();
}

class _lawyeradditionalinfoState extends State<lawyeradditionalinfo> {
  final _formKey = GlobalKey<FormState>();
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      FirebaseFirestore.instance.collection('lawyers').doc(widget.userEmail).set({
        'name': nameController.text,
        'phone_number': phoneNumberController.text,
        'dob': dobController.text,
        'company_name': post.text,
